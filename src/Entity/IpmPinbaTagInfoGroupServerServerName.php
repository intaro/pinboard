...
use App\Repository\IpmPinbaTagInfoGroupServerServerNameRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IpmPinbaTagInfoGroupServerServerNameRepository::class)]
class IpmPinbaTagInfoGroupServerServerName
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function getReqPerSec(): ?int
    {
        return $this->reqPerSec;
    }

    public function setReqPerSec(?int $reqPerSec): static
    {
