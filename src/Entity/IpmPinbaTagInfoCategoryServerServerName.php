...
use App\Repository\IpmPinbaTagInfoCategoryServerServerNameRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IpmPinbaTagInfoCategoryServerServerNameRepository::class)]
class IpmPinbaTagInfoCategoryServerServerName
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
