...
use App\Repository\IpmPinbaTagInfoGroupServerNameRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: IpmPinbaTagInfoGroupServerNameRepository::class)]
class IpmPinbaTagInfoGroupServerName
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
